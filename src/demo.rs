...
lazy_static! {
    ...
    static ref SKELETON: SkeletalData = SkeletalData {
        bones: vec![
            ...
            (  "Back", ( "Root", 17.0,  0.0, 1.00, 0.98)), // 1
            (  "Neck", ( "Back",  2.0,  0.0, 1.00, 1.00)), // 2
            (  "Head", ( "Neck",  4.0,  0.0, 1.00, 0.99)), // 3

            ( "L.Arm", ( "Back",  9.0, -D90, 1.00, 1.00)),  // 4
            ("L.Hand", ("L.Arm", 13.0,  0.0, 1.00, 1.00)), // 5
            ( "R.Arm", ( "Back",  9.0,  D90, 1.00, 1.00)), // 6
            ("R.Hand", ("R.Arm", 13.0,  0.0, 1.00, 1.00)), // 7

            (  "Hip", ( "Root",   1.0,   PI, 0.00, 1.00)), // 8

            ( "L.Leg", (  "Hip", 13.0,  0.0, 1.00, 1.00)), // 9
            ("L.Foot", ("L.Leg", 14.0,  0.0, 1.00, 1.00)), // 10
            ( "R.Leg", (  "Hip", 13.0,  0.0, 1.00, 1.00)), // 11
            ("R.Foot", ("R.Leg", 14.0,  0.0, 1.00, 1.00)) // 12
        ]
    };
}
